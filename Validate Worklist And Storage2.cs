...
{
    public class Validate_Worklist_And_Storage2 : BioSero.GreenButtonGo.GBGScript
    {

        public void Run(Dictionary<String, Object> variables, RuntimeInfo runtimeInfo)
        {
            // Insert code here:
            List<string[]> echoTable1 = Database.GetAllRows("Identifiers_Worklist_Source", new string[] {"Barcode"}).ToList();
            List<string[]> echoTable2 = Database.GetAllRows("Identifiers_Worklist_Dest", new string[] {"Barcode"}).ToList();
